...
public class MainActivity extends AppCompatActivity {
    ...
    private void initSDMICWINDOW() {
        findViewById(R.id.tv_4).setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                }, Manifest.permission.RECORD_AUDIO, Manifest.permission.WRITE_EXTERNAL_STORAGE, Manifest.permission.SYSTEM_ALERT_WINDOW);
            }
        });
        findViewById(R.id.tv_4_necessary).setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                MoPermission.Companion.requestNecessaryPermission(MainActivity.this, "获取手机信息和SD卡权限和悬浮窗权限", new OnRequestNecessaryPermissionListener() {
                    @Override
                    public void success(List<String> permissions) {
                        showToast("已获取读取SD卡,麦克风,悬浮窗权限");
                    }
    ...
    private void initSDandPhone() {
        ...
        findViewById(R.id.tv_3_necessary).setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                MoPermission.Companion.requestNecessaryPermission(MainActivity.this, "获取手机信息和SD卡权限", new OnRequestNecessaryPermissionListener() {
                    @Override
                    public void success(List<String> permissions) {
                        showToast("已获取读取手机信息权限和SD卡权限");
                    }
    ...
    private void initPhone() {
        ...
        findViewById(R.id.tv_2_necessary).setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                MoPermission.Companion.requestNecessaryPermission(MainActivity.this, "获取读取手机信息权限", new OnRequestNecessaryPermissionListener() {
                    @Override
                    public void success(List<String> permissions) {
                        showToast("已获取读取手机信息权限");
                    }
    ...
    private void initNet() {
        ...
        findViewById(R.id.tv_1_necessary).setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                MoPermission.Companion.requestNecessaryPermission(MainActivity.this, "获取网络权限", new OnRequestNecessaryPermissionListener() {
                    @Override
                    public void success(List<String> permissions) {
                        showToast("已获取网络权限");
                    }
